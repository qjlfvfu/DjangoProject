...
class LessonCRUDTests(TestCase):
    ...
    def setUp(self):
        ...
        # URL для API
        self.lessons_list_url = '/api/lessons/list/'
        self.lessons_create_url = '/api/lessons/create/'
        self.lessons_detail_url = f'/api/lessons/{self.lesson.id}/'
        self.lessons_update_url = f'/api/lessons/update/{self.lesson.id}/'
        self.lessons_delete_url = f'/api/lessons/delete/{self.lesson.id}/'
...
class PaginationTests(TestCase):
    ...
    def setUp(self):
        ...
        self.courses_url = '/api/courses/'
        self.lessons_url = '/api/lessons/list/'
