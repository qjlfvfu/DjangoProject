...
class LessonDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Lesson
        fields = [
            'id', 'name', 'description', 'preview', 'video_url', 'video_link',
            'course', 'course_name', 'owner', 'owner_email', 'created_at', 'updated_at'
        ]
...
class CourseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'owner', 'owner_email', 'lessons_count', 'lessons', 'is_subscribed'
        ]
